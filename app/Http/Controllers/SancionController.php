...
class SancionController extends Controller
{
    ...
    {
        $sanciones = Sancion::with('tipoSancion')->get();
    ...
    public function createSancion()
    {
        ...
        return view('sanciones.create', compact('tipos'));
    }
    ...
    public function storeSancion(Request $request)
    {
        ...
        return redirect()->route('sanciones.indexSancion')->with('success', 'Sanción creada correctamente.');
    }

    public function editSancion(Sancion $sancion)
    {
        $tipos = TipoSancion::all();
        return view('sanciones.edit', compact('sancion', 'tipos'));
    }
    ...
    public function updateSancion(Request $request, Sancion $sancion)
    {
        ...
        return redirect()->route('sanciones.indexSancion')->with('success', 'Sanción actualizada correctamente.');
    }

    public function destroySancion(Sancion $sancion)
    {
        $sancion->delete();
        return redirect()->route('sanciones.indexSancion')->with('success', 'Sanción eliminada correctamente.');
    }
}
