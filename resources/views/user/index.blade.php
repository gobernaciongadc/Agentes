                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;">
                                        <form action="{{ route('users.destroy', $user->id) }}" method="POST">
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm" onclick="event.preventDefault(); confirm('Esta seguro de dar de baja?') ? this.closest('form').submit() : false;" title="Dar de baja a usuario"><i class="fa fa-fw fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
