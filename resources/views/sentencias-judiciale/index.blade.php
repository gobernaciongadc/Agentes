...
<div class="row">
    <div class="col-sm-12">
        ...
        <div style="width: 45%;">
            <span class="font-weight-bold">INFORME DE JUECES Y/O SECRETARIOS</span> <br> {{ $informe->descripcion }}
        </div>
        <br>

        <div class="d-flex justify-content-between">
            <a href="{{ route('informe-index-juzgado.indexJuzgado') }}" class="btn btn-danger font-14" data-placement="left">
                <i class="fa fa-chevron-left"></i> Regresar a Información de Jueces y/o Secretarios
            </a>
